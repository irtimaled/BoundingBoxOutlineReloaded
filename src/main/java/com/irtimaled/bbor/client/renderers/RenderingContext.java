...
public class RenderingContext {
    ...
    public void endBatch() {
        ...
        futures[0] = quadBufferMaskedUploaded.submitUpload(quadBufferBuilderMasked);

        quadBufferBuilderNonMasked.end();
        futures[1] = quadBufferNonMaskedUploaded.submitUpload(quadBufferBuilderNonMasked);

        lineBufferBuilder.end();
        futures[2] = lineBufferUploaded.submitUpload(lineBufferBuilder);
