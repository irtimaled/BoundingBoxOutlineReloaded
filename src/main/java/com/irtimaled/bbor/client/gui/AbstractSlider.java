...
abstract class AbstractSlider extends AbstractControl {
    ...
    protected void renderBackground(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        this.blit(matrixStack,this.x + (int) getProgressPercentage(), this.y, 0, 46 + hoverState * 20, 4, this.height);
        this.blit(matrixStack, this.x + (int) getProgressPercentage() + 4, this.y, 196, 46 + hoverState * 20, 4, 20);
    }
