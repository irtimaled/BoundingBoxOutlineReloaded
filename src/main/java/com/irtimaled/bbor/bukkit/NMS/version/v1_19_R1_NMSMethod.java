...
public class v1_19_R1_NMSMethod extends BaseNMSMethod {
    ...
    public v1_19_R1_NMSMethod() throws ReflectiveOperationException {
        ...
        addFieldCache("worldGetStructureFeatureRegistry3", NMSClassName.IRegistry, "aN");
        addMethodCache("worldGetResourceKey", NMSMethodDescribe.of(NMSClassName.WorldServer, "ab"));
        addFieldCache("worldGetWorldData", NMSClassName.WorldServer, "N");
        ...
        addMethodCache("registryGetAllResourceKeySet", NMSMethodDescribe.of(NMSClassName.IRegistry, "f"));
