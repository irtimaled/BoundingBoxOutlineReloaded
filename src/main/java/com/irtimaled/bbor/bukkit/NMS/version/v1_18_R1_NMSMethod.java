...
public class v1_18_R1_NMSMethod extends BaseNMSMethod {

    public v1_18_R1_NMSMethod() throws ReflectiveOperationException {
        ...
        addMethodCache("worldGetStructureFeatureRegistry1", NMSMethodDescribe.of(NMSClassName.WorldServer, "t"));
        ...
        addFieldCache("worldGetStructureFeatureRegistry3", NMSFieldDescribe.of(NMSClassName.IRegistry, "aX"));
        ...
        addFieldCache("worldGetOverloadWorldKey", NMSFieldDescribe.of(NMSClassName.World, "f"));
        addMethodCache("worldGetSeed", NMSMethodDescribe.of(NMSClassName.WorldServer, "E"));
        ...
        addFieldCache("playerGetWorld", NMSFieldDescribe.of(NMSClassName.EntityPlayer, "t"));
        ...
        addFieldCache("serverGetStructureFeatureRegistry3", NMSFieldDescribe.of(NMSClassName.IRegistry, "aX"));
    }
