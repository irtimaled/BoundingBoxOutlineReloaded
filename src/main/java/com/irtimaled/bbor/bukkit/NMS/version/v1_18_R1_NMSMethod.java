...
public class v1_18_R1_NMSMethod extends BaseNMSMethod {
    ...
    public v1_18_R1_NMSMethod() throws ReflectiveOperationException {
        ...
        addFieldCache("worldGetStructureFeatureRegistry3", NMSClassName.IRegistry, "aX");
        ...
        addFieldCache("worldGetOverloadWorldKey", NMSClassName.World, "f");
        ...
        addFieldCache("playerGetWorld", NMSClassName.EntityPlayer, "t");
